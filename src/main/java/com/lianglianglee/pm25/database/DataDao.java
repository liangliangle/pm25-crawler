...
public class DataDao {
  ...
  public List<String> getAllCity() {
    ...
    try {
      ...
      while (set.next()) {
        String city = set.getString("cityname");
        citys.add(city);
      }
    } catch (SQLException e) {
      e.printStackTrace();
  ...
  public List<String> insertDevice(String station) {
    Connection con = Conn.getConn();
    List<String> stations = new ArrayList<String>();
    try {
      String sql = " insert into devices (stationname)values(?) ";
      PreparedStatement ps = con.prepareStatement(sql);
  ...
  public List<String> insertCity(String city) {
    Connection con = Conn.getConn();
    List<String> stations = new ArrayList<String>();
    try {
  ...
  public List<String> getDevice() {
    ...
    try {
      Statement stmt = con.createStatement();
      ResultSet set = stmt.executeQuery("select stationname from devices");
      while (set.next()) {
        String city = set.getString("stationname");
        citys.add(city);
      }
    } catch (SQLException e) {
      e.printStackTrace();
